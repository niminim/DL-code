...
from Playground.gurufocus.analyze_ticker import get_financial_data_for_ticker
...
def extract_score(indicators, key):
    try:
        return int(indicators[key].split('/')[0])
...
for i, ticker in enumerate(ticker_list):
    ...
    scores = {key: extract_score(main_scores, key) for key in score_keys}
