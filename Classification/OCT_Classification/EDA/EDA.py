...
data_dir = "/home/nim/Downloads/Data/OCT2017"
...
print_dict_of_count_files_in_subdirs(d) # prints the distribution
plot_train_test_class_dist(d) # plots the class-distribution in the train and test sets

# image-size distribution
res_dist, res_str_dist = calculate_image_shape_dist(data_dir) # calculates the image-size dist for each class
